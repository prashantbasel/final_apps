    ...
    <div>
      ...
      <div className="profile-container">
          ...
          {!editMode ? (
            <>
              <div className="profile-avatar">
                <div className="avatar-circle">{user.firstName ? user.firstName[0] : 'U'}</div>
                <h2 className="profile-name">{user.firstName}</h2>
                <a href="#view-profile" className="view-profile-link">View Profile</a>
              </div>
        ...
        <div className="game-status-card">
          <h4>Game Status</h4>
          <select className="game-status-dropdown">
